    ...
    <Box
      sx={{
        ...
        "&:hover": {
          ...
          boxShadow: s.glow.replace("0.15", "0.25").replace("0.10", "0.20"),
        },
      }}
    >
      <Box
...
export default function DashboardPage() {
  ...
  const hasSheetStat = Boolean(selectedSheet);
        ...
        <Box
          sx={{
            ...
            gridTemplateColumns: {
              ...
              md: hasSheetStat ? "repeat(4, minmax(0, 1fr))" : "repeat(3, minmax(0, 1fr))",
            },
            gap: 1,
            alignItems: "stretch",
            width: "100%",
            maxWidth: { md: hasSheetStat ? 640 : 480 },
          }}
        >
          <StatCard
          ...
          <StatCard
            ...
            label="WhatsApp"
            value={waLabel}
            accent={whatsappReady ? "green" : "amber"}
          />
          <StatCard
            icon={<SignalCellularAltRoundedIcon />}
            label="Sumber"
            value={sourceMode === "gsheet" ? "Google Sheet" : "Excel"}
            accent="gray"
          />
          {selectedSheet && (
            <StatCard
